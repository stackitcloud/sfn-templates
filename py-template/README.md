# STACKIT Functions - Python Function Template

This template provides a basic structure for developing serverless functions using Python for STACKIT Functions. 

## Project Structure

- `handler.py`: This is the main entry point for your function.
