# STACKIT Functions - JavaScript Function Template

This template provides a basic structure for developing serverless functions using JavaScript for STACKIT Functions. 

## Project Structure

- `handler.js`: This is the main entry point for your function.
