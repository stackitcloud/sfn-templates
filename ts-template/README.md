# STACKIT Functions - TypeScript Function Template

This template provides a basic structure for developing serverless functions using TypeScript for STACKIT Functions. 

## Project Structure

- `src/handler.ts`: This is the main entry point for your function.
