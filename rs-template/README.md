# STACKIT Functions - Rust Function Template

This template provides a basic structure for developing serverless functions using Rust for STACKIT Functions. 

## Project Structure

- `src/handler.rs`: This is the main entry point for your function.
