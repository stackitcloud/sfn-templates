# STACKIT Functions - Go Function Template

This template provides a basic structure for developing serverless functions using Go for STACKIT Functions. 

## Project Structure

- `handle.go`: This is the main entry point for your function.
