# STACKIT Functions - Quarkus Function Template

This template provides a basic structure for developing serverless functions using Quarkus for STACKIT Functions. 

## Project Structure

- `src/main/java/functions/Function.java`: This is the main entry point for your function.
